...
import com.example.demo.auth.ExternalAuthenticated;
import com.example.demo.auth.ExternalAuthenticationService;

public class DemoAuthService implements AuthenticationUserDetailsService<PreAuthenticatedAuthenticationToken> {
